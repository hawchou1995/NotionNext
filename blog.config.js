...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'af4c1c47b87441c888957055b09778b8',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '情报总橘', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一枚没有感情的橘子🍊', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xauthub.top', // 网站地址
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/xauthub', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.xauthub.top', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'f582e72b2ec1d5699add1ae0530eaf6c', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
