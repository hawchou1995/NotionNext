...
const BLOG = {
  ...
  AUTHOR: '情报总橘', // 作者
  BIO: '一枚没有感情的小橘子', // 作者简介
  LINK: 'https://hexo.xauthub.top', // 网站地址
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://waline.xauthub.top', // 请配置完整的Waline评论地址 例如 https://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
